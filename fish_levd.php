        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="fish_weid.php" class="nav-link">
                  <i class="fa-solid fa-dial-med-low"></i>
                  <p>Food-Weight (KG)</p>
                </a>
              </li>
               ...
               <ul class="nav nav-treeview">
                ...
                <ul class="nav nav-treeview">
                 ...
                 <li class="nav-item">
                   ...
                   <ul class="nav nav-treeview">
                     <li class="nav-item">
                       <a href="pages/forms/temperature.html" class="nav-link">

                         <p>temp and hum</p>
                       </a>
                     </li>
                     <li class="nav-item">
                       <a href="pages/forms/level.html" class="nav-link">

                         <p>watel level</p>
                       </a>
                     </li>
                     <li class="nav-item">
                      <a href="pages/forms/weight.html" class="nav-link">
          ...
          <div class="col-md-8">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  $select=mysqli_query($con,"SELECT * from water_lever order by id desc limit 10");
                  while($row=mysqli_fetch_array($select)){
                    $id=1;
                  ?>
                    <tr>
                      <td><?php echo"$id"?></a></td>
                      <td><?php echo"$row[34]"?></a></td>
